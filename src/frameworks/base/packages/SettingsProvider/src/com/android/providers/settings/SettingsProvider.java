...
public class SettingsProvider extends ContentProvider {
    ...
    static class Injector {
        static Uri checkUriForExtraCases(Uri soundUri, int ringtoneType) {
            ...
            if (isDrmAuthority || MediaStore.AUTHORITY.equals(authority) || android.media.ExtraRingtoneManager.isExtraCases(soundUri)) {
                if (isDrmAuthority) {
                    ...
                    return android.media.ExtraRingtoneManager.getUriForExtraCases(soundUri, ringtoneType);
                }
            }
            return soundUri;
        }
        ...
        static String getAuthority(Uri soundUri) {
            ...
            if (authority.equals(MediaStore.AUTHORITY) || android.media.ExtraRingtoneManager.isExtraCases(soundUri)) {
    ...
    public ParcelFileDescriptor openFile(Uri uri, String mode) throws FileNotFoundException {
        ...
        if (ringtoneType != -1) {
            ...
            if (soundUri != null) {
                ...
                String authority = Injector.getAuthority(soundUri); // miui modify
                soundUri = Injector.checkUriForExtraCases(soundUri, ringtoneType); // miui add
                boolean isDrmAuthority = authority.equals(DrmStore.AUTHORITY);
