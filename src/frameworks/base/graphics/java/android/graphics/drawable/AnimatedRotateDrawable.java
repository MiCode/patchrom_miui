...
public class AnimatedRotateDrawable extends Drawable implements Drawable.Callback, Runnable,
    ...
    static class Injector {
        static final int[] MIUI_FRAMES_STYLEABLE = { miui.R.attr.frameDuration, miui.R.attr.framesCount };

        static void init(AnimatedRotateDrawable d, Resources r, AttributeSet attrs) {
            TypedArray a = r.obtainAttributes(attrs, MIUI_FRAMES_STYLEABLE);
            if (a.hasValue(0)) {
                d.setFramesCount(a.getInt(0, 0));
            }
            if (a.hasValue(1)) {
                d.setFramesDuration(a.getInt(1, 0));
            }
            a.recycle();
        }
    }
    ...
    public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs)
        ...
        Injector.init(this, r, attrs); // Miui Hook
