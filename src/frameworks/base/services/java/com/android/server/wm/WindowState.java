...
final class WindowState implements WindowManagerPolicy.WindowState {
    // MIUI ADD:
    // Allowes floating window.
    final boolean mFloatingWindowAllowed;
    ...
    WindowState(WindowManagerService service, Session s, IWindow c, WindowToken token,
        ...
        // MIUI ADD:
        mFloatingWindowAllowed = WindowManagerService.Injector.isFloatingWindowAllowed(mSession.mUid);
    }
