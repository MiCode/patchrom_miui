...
class AlarmManagerService extends IAlarmManager.Stub {
    ...
    class UninstallReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            synchronized (mLock) {
                ...
                // MIUI ADD:
                pkgList = Injector.filterPersistPackages(pkgList);
    ...
    /**
     * MIUI ADD:
     * Injector to filter the {@link Injector#PERSIST_PACKAGES}.
     * make sure send broadcast to the packages.
     */
    private static class Injector {
        ...
        static String[] filterPersistPackages(String[] pkgList) {
            List<String> filteredPkgList = new ArrayList<String>();
            if (pkgList != null && pkgList.length > 0) {
                for(String pkg : pkgList) {
            ...
            return filteredPkgList.toArray(new String[] {});
        }
    }
