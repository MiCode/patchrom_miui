...
public class ConnectivityService extends IConnectivityManager.Stub {
    ...
    static class Injector {
        static void startUsingNetworkFeature(int usedNetworkType) {
            FirewallManager.getInstance().onStartUsingNetworkFeature(getCallingUid(), getCallingPid(), usedNetworkType);
        }

        public static void stopUsingNetworkFeature(FeatureUser u, int usedNetworkType) {
            FirewallManager.getInstance().onStopUsingNetworkFeature(u.mUid, u.mPid, usedNetworkType);
        }
    }
    ...
    public ConnectivityService(Context context, INetworkManagementService netd,
        ...
        FirewallService.setupService(context); // miui add
...
private NetworkStateTracker makeWimaxStateTracker() {
        ...
        try {
            ...
            if (network != null) {
                ...
                if (usedNetworkType != networkType) {
                    ...
                    Injector.startUsingNetworkFeature(usedNetworkType); // miui add
    ...
    private int stopUsingNetworkFeature(FeatureUser u, boolean ignoreDups) {
        ...
        synchronized(this) {
            ...
            Injector.stopUsingNetworkFeature(u, usedNetworkType); // miui add
