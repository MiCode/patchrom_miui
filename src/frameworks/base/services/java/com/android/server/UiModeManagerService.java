...
class UiModeManagerService extends IUiModeManager.Stub {
    ...
    static class Injector {
        static void registerUIModeScaleChangedOjbserver(final UiModeManagerService service, final Context context) {
            ContentObserver observer = new ContentObserver(new Handler()) {
                @Override
                public void onChange(boolean selfChange) {
                    synchronized (service.mLock) {
                        service.mNormalType = Settings.System.getInt(
    ...
    public UiModeManagerService(Context context) {
        ...
        Injector.registerUIModeScaleChangedOjbserver(this, mContext); // miui add
