...
public final class ShutdownThread extends Thread {
    ...
    static boolean getReboot() { return mReboot; }

    @MiuiHook(MiuiHookType.NEW_METHOD)
    static void setReboot(boolean value) { mReboot = value; }

    @MiuiHook(MiuiHookType.NEW_METHOD)
    static Object getIsStartedGuard() { return sIsStartedGuard; }

    @MiuiHook(MiuiHookType.NEW_METHOD)
    static boolean getIsStarted() { return sIsStarted; }

    @MiuiHook(MiuiHookType.NEW_METHOD)
    static void setRebootReason(String value) { mRebootReason = value; }
    ...
    static class Injector {
        ...
        static void createShutDownDialog(Context context){
            ...
            animationDrawable.setFramesCount(context.getResources().getInteger(miui.R.integer.shutdown_progress_frames_count));
            animationDrawable.setFramesDuration(context.getResources().getInteger(miui.R.integer.shutdown_progress_frames_duration));
            animationDrawable.start();
        }

        static void onDismiss(DialogInterface unused) {
            synchronized (getIsStartedGuard()){
                if (!getIsStarted()) {
                    setReboot(false);
    ...
    static void shutdownInner(final Context context, boolean confirm) {
        ...
        if (confirm) {
            ...
            final AlertDialog dialog = new AlertDialog.Builder(context)
                    ...
                    .create();
            Injector.setDialogTitle(dialog); // miui add
    ...
    public static void rebootSafeMode(final Context context, boolean confirm) {
        mReboot = true;
        mRebootSafeMode = false; // miui modify
        mRebootReason = null;
        shutdownInner(context, confirm);
    }
    ...
    private static void beginShutdownSequence(Context context) {
        ...
        Injector.createShutDownDialog(context); // miui add
