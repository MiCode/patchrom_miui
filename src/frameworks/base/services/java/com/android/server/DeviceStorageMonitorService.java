...
public class DeviceStorageMonitorService extends Binder {
    ...
    */
    private final void sendNotification() {
        ...
        Intent lowMemIntent = new Intent(ExtraIntent.ACTION_GARBAGE_CLEANUP);
        // END
        ...
        notification.icon = miui.R.drawable.stat_notify_garbage_cleanup;
        notification.largeIcon = BitmapFactory.decodeResource(mContext.getResources(),
                miui.R.drawable.ic_garbage_cleanup);
        // END
