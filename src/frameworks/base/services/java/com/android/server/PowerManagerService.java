    ...
    */
    ...
    class BrightnessState implements Runnable {
        ...
        void forceValueLocked(int value) {
            ...
            if (animating) {
                animating = false; // MiuiHook 
                // MiuiHook finishAnimationLocked(false, value);
            }
        }
    ...
    private void lightSensorChangedLocked(int value) {
        ...
        // Google does not allow this value to decrease, that is for some legacy devices.
        // Xiaomi has a better light sensor, so there's no reason to do that hack.
