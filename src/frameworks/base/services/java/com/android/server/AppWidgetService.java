...
class AppWidgetService extends IAppWidgetService.Stub
{
    ...
    static class Injector {
        static void receiveRestoreFinish(AppWidgetService service) {
            service.mContext.registerReceiver(service.mBroadcastReceiver,
                    new IntentFilter(ExtraIntent.ACTION_RESTORE_FINISH), null, null);
        }

        static boolean handleAction(AppWidgetService service, String action) {
            if (ExtraIntent.ACTION_RESTORE_FINISH.equals(action)) {
                service.getImplForUser().reload();
                return true;
            }
            return false;
        }
    ...
    public void systemReady(boolean safeMode) {
        ...
        //MIUIHOOK, update widget when restore miuiHome finish
        Injector.receiveRestoreFinish(this); // miui add
    ...
    BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (Injector.handleAction(AppWidgetService.this, action)) return; // miui add
