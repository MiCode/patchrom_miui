                ...
                if (notifyNow) {
                    if ((events & PhoneStateListener.LISTEN_SERVICE_STATE) != 0) {
                        ...
                        // MIUI ADD: START
                            ...
                            android.util.Log.e(TAG, "onServiceStateChanged failed on r=" + r + " pkg: " + r.pkgForDebug, e);
                        }
                        // END
                    }
                    if ((events & PhoneStateListener.LISTEN_SIGNAL_STRENGTH) != 0) {
                        ...
                        // MIUI ADD: START
                            ...
                            android.util.Log.e(TAG, "onSignalStrengthChanged failed on r=" + r + " pkg: " + r.pkgForDebug, e);
                        }
                        // END
                    }
                    if ((events & PhoneStateListener.LISTEN_MESSAGE_WAITING_INDICATOR) != 0) {
                        ...
                        // MIUI ADD: START
                            ...
                            android.util.Log.e(TAG, "onMessageWaitingIndicatorChanged failed on r=" + r + " pkg: " + r.pkgForDebug, e);
                        }
                        // END
                    }
                    if ((events & PhoneStateListener.LISTEN_CALL_FORWARDING_INDICATOR) != 0) {
                        ...
                        // MIUI ADD: START
                            ...
                            android.util.Log.e(TAG, "onCallForwardingIndicatorChanged failed on r=" + r + " pkg: " + r.pkgForDebug, e);
                        }
                        // END
                    }
                    if ((events & PhoneStateListener.LISTEN_CELL_LOCATION) != 0) {
                        ...
                        // MIUI ADD: START
                            ...
                            android.util.Log.e(TAG, "onCellLocationChanged failed on r=" + r + " pkg: " + r.pkgForDebug, e);
                        }
                        // END
                    }
                    if ((events & PhoneStateListener.LISTEN_CALL_STATE) != 0) {
                        ...
                        // MIUI ADD: START
                            ...
                            android.util.Log.e(TAG, "onCallStateChanged failed on r=" + r + " pkg: " + r.pkgForDebug, e);
                        }
                        // END
                    }
                    if ((events & PhoneStateListener.LISTEN_DATA_CONNECTION_STATE) != 0) {
                        ...
                        // MIUI ADD: START
                            ...
                            android.util.Log.e(TAG, "onDataConnectionStateChanged failed on r=" + r + " pkg: " + r.pkgForDebug, e);
                        }
                        // END
                    }
                    if ((events & PhoneStateListener.LISTEN_DATA_ACTIVITY) != 0) {
                        ...
                        // MIUI ADD: START
                            ...
                            android.util.Log.e(TAG, "onDataActivity failed on r=" + r + " pkg: " + r.pkgForDebug, e);
                        }
                        // END
                    }
                    if ((events & PhoneStateListener.LISTEN_SIGNAL_STRENGTHS) != 0) {
                        ...
                        // MIUI ADD: START
                            ...
                            android.util.Log.e(TAG, "onSignalStrengthsChanged failed on r=" + r + " pkg: " + r.pkgForDebug, e);
                        }
                        // END
                    }
                    if ((events & PhoneStateListener.LISTEN_OTASP_CHANGED) != 0) {
                        ...
                        // MIUI ADD: START
                            ...
                            android.util.Log.e(TAG, "onOtaspChanged failed on r=" + r + " pkg: " + r.pkgForDebug, e);
                        }
                        // END
                    }
                    if ((events & PhoneStateListener.LISTEN_CELL_INFO) != 0) {
                        ...
                        // MIUI ADD: START
                            ...
                            android.util.Log.e(TAG, "onCellInfoChanged failed on r=" + r + " pkg: " + r.pkgForDebug, e);
                        }
                        // END
                    }
                }
