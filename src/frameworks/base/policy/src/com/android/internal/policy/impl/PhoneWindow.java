...
public class PhoneWindow extends Window implements MenuBuilder.Callback {
     ...
     * @miui
     */
    protected void handleCustomizedCameraKey() {
    }

    /**
     * @miui
     */
    protected boolean handleCameraKeyEvent(DecorView decor, int keyCode, boolean isDown, Callback cb, int featureId) {
        return false;
    }
    ...
    final class DecorView extends FrameLayout implements RootViewSurfaceTaker {
        ...
        public boolean dispatchKeyEvent(KeyEvent event) {
            ...
            if (PhoneWindow.this.handleCameraKeyEvent(this, keyCode, isDown, cb, mFeatureId)) {
                return true;
            }
