...
public class Ringtone {
    ...
    static class Injector {
        static MediaPlayer tryToGetEffectiveLocalPlayer(Context context, MediaPlayer localPlayer,
                Uri defaultUri, int streamType) {
            if (localPlayer == null && defaultUri != null) {
                localPlayer = new MediaPlayer();
                try {
                    localPlayer.setDataSource(context, defaultUri);
                    localPlayer.setAudioStreamType(streamType);
                    localPlayer.prepare();
                    Log.d(TAG, "[MIUI] Inject to use defalut ringtone uri");
                } catch (Exception e) {
                    if (localPlayer != null) {
                        localPlayer.reset();
                        localPlayer.release();
                    ...
                    Log.e(TAG, "[MIUI] Try to get effective local player fail");
                }
            }
            return localPlayer;
        }
    ...
    // MIUI MOD:
    // public void setUri(Uri uri) {
    public void setUri(Uri uri, Uri defaultUri) {
        destroyLocalPlayer();
        ...
        // MIUI ADD:
        mLocalPlayer = Injector.tryToGetEffectiveLocalPlayer(mContext, mLocalPlayer, defaultUri, mStreamType);
