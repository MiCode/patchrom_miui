...
public class StatusBarIcon implements Parcelable {
     ...
     * MIUI ADD:
     * [JB41_42_COMPAT]
     * jb42 adds a UserHandle field in StatusBarIcon, adds this constructor in both jb41 and jb42
     */
    public StatusBarIcon(StatusBarNotification notification, int iconId, int iconLevel, int number,
            CharSequence contentDescription) {
        this(notification.pkg, iconId, iconLevel, number, contentDescription);
    }
}
