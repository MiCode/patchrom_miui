...
public class RuntimeInit {
    ...
    public static String callGetDefaultUserAgent() { return getDefaultUserAgent(); }

    @MiuiHook(MiuiHookType.NEW_CLASS)
    static class Injector {
        static String appendMiuiVersion(StringBuilder result, String id) {
    ...
    private static String getDefaultUserAgent() {
        ...
        String id = Injector.appendMiuiVersion(result, Build.ID); // miui modify
        if (id.length() > 0) {
            result.append(" Build/");
            result.append(id);
        }
