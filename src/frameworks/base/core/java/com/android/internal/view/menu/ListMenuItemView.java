...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView {
    ...
    static class Injector {
        static boolean insertRadioButton(ListMenuItemView v, RadioButton child) {
            if (UiUtils.isV5Ui(v.getContext())) {
                child.setButtonDrawable(miui.R.drawable.v5_dialog_btn_radio_light);
                child.setPadding(0, 0, miui.widget.CheckedTextView.CHECK_MARK_PADDING, 0);
                MarginLayoutParams layoutParams = null;
                ViewGroup.LayoutParams lp = child.getLayoutParams();
                if (lp instanceof MarginLayoutParams) {
                    layoutParams = (MarginLayoutParams) lp;
                } else {
                    layoutParams = new MarginLayoutParams(lp);
                }

                View next = v.getChildAt(0);
                if (next != null) {
                    layoutParams.rightMargin = -next.getPaddingLeft();
                    lp = next.getLayoutParams();
                    if (lp instanceof MarginLayoutParams) {
                        MarginLayoutParams mlp = (MarginLayoutParams) lp;
                        layoutParams.rightMargin -= mlp.leftMargin;
                    }
                }
                layoutParams.height = ViewGroup.LayoutParams.MATCH_PARENT;

                v.addView(child, 0, layoutParams);
                return true;
            }
        ...
        static boolean insertCheckBox(ListMenuItemView v, CheckBox child) {
            if (UiUtils.isV5Ui(v.getContext())) {
                MarginLayoutParams layoutParams = null;
                ViewGroup.LayoutParams lp = child.getLayoutParams();
                if (lp instanceof MarginLayoutParams) {
                ...
                child.setPadding(-layoutParams.rightMargin, 0, miui.widget.CheckedTextView.CHECK_MARK_PADDING, 0);
                v.addView(child, 0, layoutParams);
                return true;
            }
    ...
    private void insertRadioButton() {
        ...
        // Miui Hook
        if (Injector.insertRadioButton(this, mRadioButton)) {
            return;
        }
    ...
    private void insertCheckBox() {
        ...
        // Miui Hook
        if (Injector.insertCheckBox(this, mCheckBox)) {
            return;
        }
