...
public class GlowPadView extends View {
    ...
    void callDeactivateTargets() { deactivateTargets(); }

    @MiuiHook(MiuiHookType.NEW_METHOD)
    void callDispatchTriggerEvent(int whichTarget) { dispatchTriggerEvent(whichTarget); }

    @MiuiHook(MiuiHookType.NEW_METHOD)
    void callVibrate() { vibrate(); }

    @MiuiHook(MiuiHookType.NEW_METHOD)
    String callGetTargetDescription(int index) { return getTargetDescription(index); }

    @MiuiHook(MiuiHookType.NEW_METHOD)
    void callSetGrabbedState(int newState) { setGrabbedState(newState); }

    @MiuiHook(MiuiHookType.NEW_METHOD)
    void callAnnounceTargets() { announceTargets(); }

    @MiuiHook(MiuiHookType.NEW_METHOD)
    AnimationBundle getTargetAnimations() { return mTargetAnimations; }

    @MiuiHook(MiuiHookType.NEW_METHOD)
    TargetDrawable getHandleDrawable() { return mHandleDrawable; }

    @MiuiHook(MiuiHookType.NEW_METHOD)
    void setGlowRadius(float value) { mGlowRadius = value; }

    @MiuiHook(MiuiHookType.NEW_METHOD)
    void setAnimatingTargets(boolean value) { mAnimatingTargets = value; }

    @MiuiHook(MiuiHookType.NEW_METHOD)
    ArrayList<TargetDrawable> getTargetDrawables() { return mTargetDrawables; }

    @MiuiHook(MiuiHookType.NEW_METHOD)
    AnimatorUpdateListener getUpdateListener() { return mUpdateListener; }

    @MiuiHook(MiuiHookType.NEW_METHOD)
    AnimatorListener getResetListener() { return mResetListener; }

    @MiuiHook(MiuiHookType.NEW_METHOD)
    AnimatorListener getResetListenerWithPing() { return mResetListenerWithPing; }

    @MiuiHook(MiuiHookType.NEW_METHOD)
    TargetDrawable getOuterRing() { return mOuterRing; }

    @MiuiHook(MiuiHookType.NEW_METHOD)
    boolean getDragging() { return mDragging; }

    @MiuiHook(MiuiHookType.NEW_METHOD)
    void setDragging(boolean value) { mDragging = value; }

    @MiuiHook(MiuiHookType.NEW_METHOD)
    float getWaveCenterX() { return mWaveCenterX; }

    @MiuiHook(MiuiHookType.NEW_METHOD)
    float getWaveCenterY() { return mWaveCenterY; }

    @MiuiHook(MiuiHookType.NEW_METHOD)
    float getOuterRadius() { return mOuterRadius; }

    @MiuiHook(MiuiHookType.NEW_METHOD)
    float getSnapMargin() { return mSnapMargin; }

    @MiuiHook(MiuiHookType.NEW_METHOD)
    int getActiveTarget() { return mActiveTarget; }
    ...
    @MiuiHook(MiuiHookType.CHANGE_ACCESS)
    void hideTargets(boolean animate, boolean expanded) {
