...
public class ActionBarImpl extends ActionBar {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        // In most case, methods in children views will be called in bellow order:
        // ActionBarView.onConfigurationChanged => ActionBarContainer.onMeasure.
        // This is right for ActionBarView.onConfigurationChanged would update
        // content height before ActionBarContainer.onMeasure called.
        // But when activity is hidden (for example, it has been bring to background),
        // methods in children views will be called in bellow order:
        // ActionBarContainer.onMeasure => ActionBarView.onConfigurationChanged.
        // In that case, ActionBarContainer.onMeasure can't get right content height and
        // cause bug MIUI-1051. So dispatch configuration changed event here to
        // make sure that ActionBarView.onConfigurationChanged is called before
        // ActionBarContainer.onMeasure.
        if (!mActivity.isResumed()) {
            mContainerView.dispatchConfigurationChanged(newConfig);
            mSplitView.dispatchConfigurationChanged(newConfig);
        }
