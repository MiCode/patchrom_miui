...
public final class ViewRootImpl implements ViewParent,
    ...
    static class Injector {
        @MiuiHook(MiuiHookType.NEW_METHOD)
        static boolean tryToSkipResizedMsg(ViewRootImpl impl, ResizedInfo ri, Message msg) {
            if (impl.mWinFrame.width() == msg.arg1 && impl.mWinFrame.height() == msg.arg2
                    && impl.mPendingContentInsets.equals(ri.contentInsets)
                    && ((ResizedInfo)msg.obj).newConfig == null
                    && impl.mSkipResizedMsg) {
                impl.mSkipResizedMsg = false;
                return true;
            }
            return false;
        }
    ...
    final class ViewRootHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            case MSG_RESIZED:
                ...
                if (Injector.tryToSkipResizedMsg(ViewRootImpl.this, ri, msg)) {
                    break;
                } // miui add
