...
public class View implements Drawable.Callback, Drawable.Callback2, KeyEvent.Callback,
    ...
    static class Injector {
        static void performHapticFeedbackOnRelease(View view) {
            view.performHapticFeedback(HapticFeedbackConstants.VIRTUAL_RELEASED,
        ...
        static boolean isHapticEnabledExplictly(View view, int flags) {
            if (((flags & HapticFeedbackConstants.FLAG_WHEN_ENABLED_EXPLICITLY) != 0)
                    && !view.mHapticEnabledExplicitly) {
                return false;
            }
            return true;
        }
    ...
    */
        ...
        for (int i = 0; i < N; i++) {
            ...
            switch (attr) {
                ...
                case com.android.internal.R.styleable.View_hapticFeedbackEnabled:
                    mHapticEnabledExplicitly = a.getBoolean(attr, false); // miui add
    ...
    public void setHapticFeedbackEnabled(boolean hapticFeedbackEnabled) {
        ...
        mHapticEnabledExplicitly = hapticFeedbackEnabled; // miui add
    }
            ...
            switch (event.getAction()) {
                    ...
                    if ((mPrivateFlags & PRESSED) != 0 || prepressed) {
                        ...
                        if (!mHasPerformedLongPress) {
                            ...
                            if (!focusTaken) {
                                ...
                                Injector.performHapticFeedbackOnRelease(this); // miui add
                ...
                case MotionEvent.ACTION_DOWN:
                    ...
                    if (isInScrollingContainer) {
                        ...
                        setPressed(true);
                        checkForLongClick(0);
                        Injector.performHapticFeedbackOnDown(this); // miui add
                    }
                    break;
    ...
    */
    ...
    public boolean performHapticFeedback(int feedbackConstant, int flags) {
        ...
        if (! Injector.isHapticEnabledExplictly(this, flags)) {
            return false;
        } // miui add
