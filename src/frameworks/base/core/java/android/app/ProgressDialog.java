...
public class ProgressDialog extends AlertDialog {
    ...
    static class Injector {
        static void usingV5Style(ProgressDialog progressDialog, Context context,
                TextView messageView) {
            if (UiUtils.isV5Ui(context)) {
                messageView.setTextAppearance(context, miui.R.style.V5_TextAppearance_ProgressDialogMessage);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mProgressStyle == STYLE_HORIZONTAL) {
            ...
            Injector.usingV5Style(this, mContext, mMessageView); // Miui Hook
        }
        a.recycle();
        if (mMax > 0) {
            setMax(mMax);
