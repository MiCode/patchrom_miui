...
public abstract class BackupAgent extends ContextWrapper {
    ...
    // MIUI ADD:
    // skip special file for fixing blocking bug sometime
    private boolean shouldSkip(int mode) {
        return !OsConstants.S_ISREG(mode) && !OsConstants.S_ISDIR(mode);
    }
