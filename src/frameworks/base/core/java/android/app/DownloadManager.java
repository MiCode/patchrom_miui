...
public class DownloadManager {
    ...
    Uri getBaseUri() { return mBaseUri; }

    @MiuiHook(MiuiHookType.NEW_CLASS)
    static class Injector {
        static String addParens(String str) {
            return "(" + str + ")";
        }

        static String getLocalUri(CursorTranslator translator) {
            long destinationType = translator.getLong(translator.getColumnIndex(Downloads.Impl.COLUMN_DESTINATION));
            if (destinationType == Downloads.Impl.DESTINATION_FILE_URI ) {
                return translator.getString(translator.getColumnIndex(Downloads.Impl.COLUMN_FILE_NAME_HINT));
            }
            return translator.callGetLocalUri();
        }

        public static long getPausedReason(int status) {
            if (status == Downloads.Impl.STATUS_PAUSED_BY_APP) {
                return MiuiDownloadManager.PAUSED_BY_APP;
            }
    ...
    public static class Query {
        @MiuiHook(MiuiHookType.NEW_METHOD)
        void setOrderByColumn(String value) { mOrderByColumn = value; }

        @MiuiHook(MiuiHookType.NEW_METHOD)
        void setOrderDirection(int value) { mOrderDirection = value; }
        ...
        Cursor runQuery(ContentResolver resolver, String[] projection, Uri baseUri) {
            ...
            if (mStatusFlags != null) {
                ...
                selectionParts.add(Injector.addParens(joinStrings(" OR ", parts))); // miui modify
            }
            ...
            addExtraSelectionParts(selectionParts); // miui add
    ...
    static class CursorTranslator extends CursorWrapper {
        @MiuiHook(MiuiHookType.NEW_METHOD)
        String callGetLocalUri() { return getLocalUri(); }
        ...
        public String getString(int columnIndex) {
            return (getColumnName(columnIndex).equals(COLUMN_LOCAL_URI)) ? Injector.getLocalUri(this) :
                    super.getString(columnIndex); // miui modify
        }
        ...
        private long getPausedReason(int status) {
            switch (status) {
                ...
                default:
                    return Injector.getPausedReason(status); // miui modify
            }
        }
