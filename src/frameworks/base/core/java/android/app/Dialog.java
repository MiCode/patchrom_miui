...
public class Dialog implements DialogInterface, Window.Callback,
    ...
    static class Injector {
        static void setDialogGravity(Dialog dialog, int themeResId) {
            if (UiUtils.isV5Ui(dialog.getContext())) {
                dialog.getWindow().setGravity(Gravity.BOTTOM);
            }
        }

        static ActionBarImpl generateActionBar(Dialog dialog) {
            return UiUtils.isV5Ui(dialog.getContext()) ? new com.miui.internal.v5.app.ActionBarImpl(dialog) : new ActionBarImpl(dialog);
        }

        static void onWindowShow(Dialog dialog) {
        ...
        static void onWindowHide(Dialog dialog) {
            ActionBar actionBar = dialog.getActionBar();
            if (actionBar instanceof com.miui.internal.v5.app.ActionBarImpl) {
    ...
    Dialog(Context context, int theme, boolean createContextWrapper) {
        ...
        Injector.setDialogGravity(this, theme); // Miui Hook
    }
