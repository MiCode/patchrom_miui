...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    static class Injector {
        static Drawable getDrawable(PackageManager pm, String pkg, int iconId, ActivityInfo activityInfo) {
    ...
    private Drawable getActivityIcon(ComponentName component) {
        ...
        Drawable drawable = Injector.getDrawable(pm, pkg, iconId, activityInfo); // miui modify
        if (drawable == null) {
