...
public class EdgeEffect {
    ...
    static class Injector {
        static Drawable getOverScrollEdge(Context context) {
            Drawable d = UiUtils.getDrawable(context, miui.R.attr.v5_over_scroll_edge);
            return d == null ? context.getResources().getDrawable(miui.R.drawable.android_overscroll_edge) : d;
        }

        static Drawable getOverScrollGlow(Context context) {
            Drawable d = UiUtils.getDrawable(context, miui.R.attr.v5_over_scroll_glow);
            return d == null ? context.getResources().getDrawable(miui.R.drawable.android_overscroll_glow) : d;
        }
    }
    ...
    public EdgeEffect(Context context) {
        ...
        mEdge = Injector.getOverScrollEdge(context); // Miui Hook
        mGlow = Injector.getOverScrollGlow(context); // Miui Hook
