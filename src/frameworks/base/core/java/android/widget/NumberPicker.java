...
public class NumberPicker extends LinearLayout {
    ...
    /** @hide **/
    @MiuiHook(MiuiHookType.NEW_METHOD)
    protected SparseArray<String> getSelectorIndexToStringCache() {
    ...
    /** @hide **/
    @MiuiHook(MiuiHookType.NEW_METHOD)
    protected void reInitiate(int selectorWheelItemCount, int maxHeight,
            int selectionDividersDistance, boolean needSoftInput) {
        //重新初始化SELECTOR_WHEEL_ITEM_COUNT，及其关联的变量
