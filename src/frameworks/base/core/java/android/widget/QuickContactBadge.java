...
public class QuickContactBadge extends ImageView implements OnClickListener {
    ...
    static class Injector {
        static Uri showQuickContactForStranger(QuickContactBadge badge, boolean trigger, Uri lookupUri, Uri createUri) {
    ...
    private class QueryHandler extends AsyncQueryHandler {
        ...
        protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
            ...
            createUri = Injector.showQuickContactForStranger(QuickContactBadge.this, trigger, lookupUri, createUri); // miui add
            if (trigger && lookupUri != null) {
