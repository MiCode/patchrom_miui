...
public class StaticLayout extends Layout {
    ...
    static class Injector {
        ...
        static boolean isIdeographic(char c, boolean includeNonStarters)  {
            if (c >= '\u3001' && c <= '\u3017') {
                switch (c) {
                    case '\u300A': //  # CHINESE SHUMINGHAO
                    case '\u300E': //  # CHINESE YINHAO
                    case '\u3010': //  # CHINESE ZHONGKUOHAO
                    case '\u3016': //  # CHINESE DAKUOHAO
                        return false;
                }
                switch (c) {
                    case '\u3001': // # CHINESE DUNHAO
                    case '\u3002': // # CHINESE JUHAO
                    case '\u300B': // # CHINESE SHUMINGHAO
                    case '\u300F': // # CHINESE FANYINHAO
                    case '\u3011': // # CHINESE FANZHONGKUOHAO
                    case '\u3017': // # CHINESE FANDAKUOHAO
                        return includeNonStarters;
                }
            }
            if (c == '\uFE5D') {
                return false; //  # CHINESE XIAOKUOHAO
            } else if (c == '\uFE5E') {
                return includeNonStarters; //  # CHINESE FANXIAOKUOHAO
            }
            if (c >= '\uFF01' && c <= '\uFF1F') {
                if (c == '\uFF08') {
                    return false; // # CHINESE YUANKUOHAO
                }
                switch (c) {
                    case '\uFF01': //  # CHINESE TANHAO
                    case '\uFF09': //  # CHINESE FANYUANKUOHAO
                    case '\uFF0C': //  # CHINESE DOUHAO
                    case '\uFF1A': //  # CHINESE MAOHAO
                    case '\uFF1B': //  # CHINESE FENHAO
                    case '\uFF1F': //  # CHINESE WENHAO
            ...
            for (int spanStart = paraStart, spanEnd; spanStart < paraEnd; spanStart = spanEnd) {
                ...
                for (int j = spanStart; j < spanEnd; j++) {
                    ...
                    if (w <= width) {
                         ...
                         */
                        c = Injector.validateCJKCharAsSpace(c, chs, j, spanEnd, paraStart); // miui add
    ...
    private static final boolean isIdeographic(char c, boolean includeNonStarters) {
        ...
        return Injector.isIdeographic(c, includeNonStarters); // miui modify
    }
