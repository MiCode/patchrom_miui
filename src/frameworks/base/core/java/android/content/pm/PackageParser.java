...
public class PackageParser {
    ...
    static class Injector {
       ...
       static int checkPriority(int flags, int priority) {
    ...
    public Package parsePackage(File sourceFile, String destCodePath,
        ...
        try {
            ...
            if (cookie != 0) {
                res = new MiuiResources(assmgr, metrics, null); // miui modify
    ...
    private static String parsePackageName(XmlPullParser parser,
        ...
        String nameError = Injector.filterNameError(pkgName, validateName(pkgName, true)); // miui modify
    ...
    private Package parsePackage(
        ...
        if (str != null && str.length() > 0) {
            String nameError = Injector.filterNameError(pkgName, validateName(str, true)); // miui modify
            if (nameError != null && !"android".equals(pkgName)) {
    ...
    private boolean parseIntent(Resources res,
        ...
        outInfo.setPriority(Injector.checkPriority(flags, priority)); // miui modify
