...
public class ClipboardManager extends android.text.ClipboardManager {
    ...
    public void setPrimaryClip(ClipData clip) {
        try {
            addClipDataExtra(clip); // miui add
    ...
    private void addClipDataExtra(ClipData clip) {
        if (clip != null && clip.getItemCount() > 0) {
            ClipServiceManagerExtra.getInstance().addData(clip.getItemAt(0).coerceToText(mContext));
        }
    }
