...
public class Resources {
    ...
    static class Injector {
        ...
        static void setDrawableId(int id) { mId = id; } 
        ...
        synchronized (mTmpValue) {
            ...
            if (config != null) {
                ...
                configChanges = ActivityInfo.activityInfoConfigToNative(configChanges)
                                | (configChanges & ExtraActivityInfo.CONFIG_MASK); // miui modify
            }
    ...
    /*package*/ Drawable loadDrawable(TypedValue value, int id)
        ...
        //                System.out.println("Opened file " + file + ": " + is);
                        Injector.setDrawableId(id); // miui add
                        dr = Injector.createFromResourceStream(this, value, is,
                                file, null); // miui modify
                        is.close();
    ...
    private TypedArray getCachedStyledAttributes(int len) {
        synchronized (mTmpValue) {
            ...
            return new MiuiTypedArray(this, // miui modify
