...
public class CallLog {
    ...
    static class Injector {
        static ContentValues getExtraCallLogValues(ContentValues contentValues) {
            ...
            if (Calls.sExtraCallLogValues == null) {
                ...
                values = Calls.sExtraCallLogValues;
    ...
    public static class Calls implements BaseColumns {
        ...
        public static Uri addCall(CallerInfo ci, Context context, String number,
            ...
            ContentValues values = Injector.getExtraCallLogValues(new ContentValues(5)); // miui modify
            ...
            Injector.removeExpiredEntries(context); // miui modify
