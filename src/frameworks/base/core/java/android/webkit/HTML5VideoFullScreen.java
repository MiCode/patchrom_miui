...
public class HTML5VideoFullScreen extends HTML5VideoView
    ...
    View.OnTouchListener, MediaPlayer.OnVideoSizeChangedListener {
    ...
    public void onVideoSizeChanged(MediaPlayer mp, int width, int height) {
        if (mVideoWidth == width && mVideoHeight == height) return;
        mVideoWidth = width;
        mVideoHeight = height;
        // This will trigger onMeasure() to set display ratio correctly.
        mVideoSurfaceView.getHolder().setFixedSize(mVideoWidth, mVideoHeight);
    }
