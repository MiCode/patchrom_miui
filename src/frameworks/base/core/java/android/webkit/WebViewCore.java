...
public final class WebViewCore {
    ...
    @MiuiHook(MiuiHookType.NEW_FIELD)
    private Vector<String> mReadModeTemplateVector = new Vector<String>();
    ...
    @MiuiHook(MiuiHookType.NEW_METHOD)
    public void setmReadModeTemplate(Vector<String> readModeTemplate) {
    ...
    */
                ...
                public void handleMessage(Message msg) {
                    ...
                    switch (msg.what) {
                        ...
                        case CHECK_READ_MODE:
                            ...
                            String [] arr = nativeSwitchReadMode(mNativeClass, msg.arg1 == 1, mReadModeTemplateVector);
                            if (arr != null) {
                                mReadModeString[0] = arr[0];
                                mReadModeString[1] = arr[1];
                                mReadModeString[2] = arr[2];
                                long difference = System.currentTimeMillis() - begin;
                                Log.d("time-cost", "get read mode string cost time(ms): " + difference);
                                mWebViewClassic.mPrivateHandler.obtainMessage(WebViewClassic.SWITCH_READ_MODE, null).sendToTarget();
                            }
                            break;
    ...
    @MiuiHook(MiuiHookType.NEW_METHOD)
    /* package */ String[] getReadModeString() {
