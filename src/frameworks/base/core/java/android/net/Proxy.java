...
public final class Proxy {
    ...
    static class Injector {
        static String getHostName(InetSocketAddress sa) {
            String hostStr = null;
            if (sa.getAddress() != null) {
                hostStr = sa.getAddress().getHostAddress();
            }
            if (TextUtils.isEmpty(hostStr)) {
                hostStr = sa.getHostName();
            }
            return hostStr;
        }
    }
    ...
    public static final HttpHost getPreferredHttpHost(Context context,
        ...
        if (prefProxy.equals(java.net.Proxy.NO_PROXY)) {
            ...
            return new HttpHost(Injector.getHostName(sa), sa.getPort(), "http"); // miui modify
        }
    }
