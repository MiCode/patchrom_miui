...
public class TypedValue {
    ...
    /**
     * If miui_font_scale is set in app's resources, font size will multiplied with this value.
     * @hide
     */
    @MiuiHook(MiuiHookType.NEW_FIELD)
    public static float miui_font_scale = 1.0f;
    /* ------------------------------------------------------------ */
                                       ...
                                       DisplayMetrics metrics)
    {
        ...
        case COMPLEX_UNIT_SP:
            return miuiScale(value, metrics);
    ...
    private static float miuiScale(float value, DisplayMetrics metrics) {
        if (value >= 20) {
            return value * metrics.density;
        } else {
            return value * metrics.scaledDensity * miui_font_scale;
        }
    }
