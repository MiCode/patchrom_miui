    ...
    public static class LayoutParams extends FrameLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            removeBorders = a.getBoolean(
                    ...
                    false);
            removeBorders = Injector.isRemoveBorders(c, removeBorders); // miui add
            a.recycle();
        }
        ...
        static class Injector {
            public static boolean isRemoveBorders(Context context, boolean removeBorders) {
                boolean ret = removeBorders;
