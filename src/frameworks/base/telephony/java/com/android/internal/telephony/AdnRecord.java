...
public class AdnRecord implements Parcelable {
    ...
    static class Injector {
        ...
        static String adnRecordError(AdnRecord record, String prefix) {
            return prefix + " - [" + record.number + "," + record.alphaTag + "," + record.emails + "]";
        }
    }
    ...
    static final int MAX_NUMBER_SIZE_BYTES = 0xff;
    ...
    public byte[] buildAdnString(int recordSize) {
        ...
        if (TextUtils.isEmpty(number)) {
            ...
            if (!TextUtils.isEmpty(alphaTag)) {
                ...
                Injector.arraycopy(byteTag, 0, adnString, 0, byteTag.length); // miui modify
                MiuiAdnUtils.encodeAlphaTag(adnString, alphaTag, footerOffset); // miui add
            }
    ...
    parseRecord(byte[] record) {
        try {
            ...
            Log.w(LOG_TAG, Injector.adnRecordError(this, "Error parsing AdnRecord"), ex);
            number = "";
            alphaTag = "";
            emails = null;
        }
