...
final class GsmServiceStateTracker extends ServiceStateTracker {
    ...
    static class Injector {
        static String getPlmn(GsmServiceStateTracker tracker, String operator){
            String plmn = ((SIMRecords) tracker.phone.mIccRecords).mSpnOverride.getSpn(tracker.ss.getOperatorNumeric());
    ...
    protected void updateSpnDisplay() {
        ...
        String spn = Injector.getSpn(this, phone.mIccRecords.getServiceProviderName()); // miui modify
        String plmn = Injector.getPlmn(this, ss.getOperatorAlphaLong()); // miui modify
    ...
    private void pollStateDone() {
        ...
        if (hasChanged) {
            ...
            if (TextUtils.isEmpty(operatorNumeric)) { // miui modify
