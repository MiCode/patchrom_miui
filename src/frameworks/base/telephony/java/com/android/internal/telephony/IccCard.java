        ...
        if (transitionedIntoPinLocked) {
            ...
            broadcastIccStateChangedIntent(IccCardConstants.INTENT_VALUE_ICC_LOCKED,
                    (newState == State.PIN_REQUIRED) ?
                       IccCardConstants.INTENT_VALUE_LOCKED_ON_PIN : IccCardConstants.INTENT_VALUE_LOCKED_ON_PUK);
        ...
        public void handleMessage(Message msg){
            ...
            switch (msg.what) {
                case EVENT_RADIO_OFF_OR_NOT_AVAILABLE:
                    mState = null;
                    updateStateProperty();
                    broadcastIccStateChangedIntent(IccCardConstants.INTENT_VALUE_ICC_NOT_READY, null);
                    break;
                case EVENT_RADIO_ON:
                    if (!is3gpp) {
