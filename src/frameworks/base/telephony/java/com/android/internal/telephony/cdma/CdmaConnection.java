...
public class CdmaConnection extends Connection {
    ...
    static class Injector {
        static void setPostDialState(CdmaConnection conn, PostDialState s) { }
        static String nullifyString(String str) { return null; }
    }
    ...
    processPostDialChar(char c) {
        if (PhoneNumberUtils.is12Key(c)) {
            ...
            Injector.setPostDialState(this, PostDialState.PAUSE); // miui modify
    ...
    public String getRemainingPostDialString() {
        ...
        if (Injector.nullifyString(subStr) != null) { // miui modify
