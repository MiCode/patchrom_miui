...
public abstract class PhoneBase extends Handler implements Phone {
    ...
    */
    ...
    protected void sendDeviceIdReadyBroadcast() {
        Intent intent = new Intent(ExtraTelephonyManager.ACTION_DEVICE_ID_READY);
        intent.putExtra(ExtraTelephonyManager.EXTRA_DEVICE_ID, getDeviceId());
     ...
     * MIUI ADD: START
     */
    protected void setDeviceIdSystemProperty() {
        if (!TextUtils.isEmpty(getDeviceId())) {
            setSystemProperty(TelephonyProperties.PROPERTY_DEVICE_ID, getDeviceId());
        }
    }
}
