...
public class SmsMessage extends SmsMessageBase {
    ...
    private void parsePdu(byte[] pdu) {
        ...
        // MIUI:Support get MO sms on SIM card
        case 1:
     ...
     *
     * Format:
     * | SCA:1-12 | FO:1 | MR:1 | DA:2-12 | PID:1 | DSC:1 | VP:1 | UDL:1 | UD:0-140 |
    ...
    private void parseSmsSubmit(PduParser p, int firstByte) {
        ...
        if (recipientAddress != null) {
            Log.v(LOG_TAG, "SMS recipient address: "
    ...
    /**
     * Returns the recipient address in string type
     * @hide
     */
    @MiuiHook(MiuiHookType.NEW_METHOD)
    public String getRecipientAddress() {
        if (recipientAddress != null) {
            ...
            Log.v(LOG_TAG, "SMS recipient address is null");
            return null;
        }
    }
}
