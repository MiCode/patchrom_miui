...
public class TelephonyManager {
    ...
    static Context getContext() { return sContext; }

    @MiuiHook(MiuiHookType.NEW_CLASS)
    static class Injector {
        static String getSimOperator(String op) {
            return miui.telephony.ExtraTelephonyManager.getSimOperator(getContext());
        }
    }
    ...
    public String getSimOperator() {
        return Injector.getSimOperator(SystemProperties.get(TelephonyProperties.PROPERTY_ICC_OPERATOR_NUMERIC)); // miui modify
    }
