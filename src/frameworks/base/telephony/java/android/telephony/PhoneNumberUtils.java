...
public class PhoneNumberUtils
{
    ...
    static int callIndexOfLastNetworkChar(String a) { return indexOfLastNetworkChar(a); }

    @MiuiHook(MiuiHookType.NEW_CLASS)
    static class Injector {
        static int getEffectiveLength(String str) {
    ...
    compareLoosely(String a, String b) {
        ...
        if (matched < MIN_MATCH) {
            int effectiveALen = Injector.getEffectiveLength(a) - numNonDialableCharsInA;    // miui modify
            int effectiveBLen = Injector.getEffectiveLength(b) - numNonDialableCharsInB;    // miui modify
    ...
    public static String formatNumber(
        ...
        phoneNumber = miui.telephony.PhoneNumberUtils.removeDashesAndBlanks(phoneNumber); // miui add
        int len = phoneNumber.length();
        for (int i = 0; i < len; i++) {
    ...
    private static boolean isEmergencyNumberInternal(String number,
        ...
        number = miui.telephony.PhoneNumberUtils.parseNumber(number); // miui add
